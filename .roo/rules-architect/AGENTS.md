...
- **State ownership** — Extension owns local state via VS Code Memento. GitHub is the remote source of truth. In-memory state is a cache for delta detection, not authoritative.
